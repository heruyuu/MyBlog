    ...
    <div class="col-md-12">
       <div class="card">
          <div class="card-body">
             ...
             <!-- thumbnail:true -->
                <div class="category-tumbnail" style="background-image: url('{{ asset($category->thumbnail) }}');"></div>
             @else
             <!-- thumbnail:false -->
                ...
                <text x="50%" y="50%" dominant-baseline="middle" text-anchor="middle" fill="#dee2e6" dy=".3em" font-size="24">{{ $category->title }}</text>
            </svg>
             @endif
             <!-- title -->
             <h2 class="my-1">
